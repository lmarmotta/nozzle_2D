...
void export_fields(t_points ** pnts, t_define p_setup){
    ...
    for (int j = 0; j < p_setup.jmax; j++){
        for (int i = 0; i < p_setup.imax; i++){
            ...
            double rhs_0 = pnts[i][j].J * pnts[i][j].q_hat[0];
            double rhs_1 = pnts[i][j].J * pnts[i][j].q_hat[1];
            double rhs_2 = pnts[i][j].J * pnts[i][j].q_hat[2];
            double rhs_3 = pnts[i][j].J * pnts[i][j].q_hat[3];
